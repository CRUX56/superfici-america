...
<div id="Top_bar" class="loading">
	...
	<!--ADD PHONE # AND SOCIAL MEDIA FUNCTIONALITY-->
	<section id="wfc-nav-top-bar" class="section mcb-section">
		<div class="section_wrapper mcb-section-inner">
			<div class="wrap mcb-wrap one clearfix">
				<div class="mcb-wrap-inner">
					<div class="column mcb-column one-second column_column column-margin-">
						<div class="column_attr clearfix">
							<!--Hi there The phone # will go over here-->
              <?php dynamic_sidebar('wfc-sticky-left-menu'); ?>
						</div>
					</div>
					<div class="column mcb-column one-second column_column column-margin- wfc-social-links">
						<div class="column_attr clearfix">
							<!--PULL IN CUSTOM MENU FROM FUNCTIONS.PHP FILE-->
              <?php
                wp_nav_menu( array(
                  'theme_location' => 'wfc-social-media-menu',
	...
	<div class="container">
		<div class="column one">
			...
			<div class="top_bar_left clearfix">
				...
				<!-- DMC Secondary Logo Call -->
				<div class="logo<?php if( $textlogo = mfn_opts_get('logo-text') ) echo ' text-logo'; ?> dmc-logo">
					<?php
						// Logo | Options
						$logo_options = mfn_opts_get( 'logo-secondary-img' ) ? mfn_opts_get( 'logo-secondary-img' ) : false;
						$logo_before = $logo_after = '';

						// Logo | Link
						if( isset( $logo_options['link'] ) ){
							$logo_before 	= '<a id="logo" class="dmc-logo-secondary" href="'. get_home_url() .'" title="'. get_bloginfo( 'name' ) .'">';
							$logo_after 	= '</a>';
						} else {
							$logo_before 	= '<span id="logo">';
							$logo_after 	= '</span>';
						...
						if( $layoutID = mfn_layout_ID() ){
							...
							$logo_src 		= mfn_opts_get( 'logo-secondary-img', THEME_URI .'/images/logo/logo.png' );
							$logo_sticky 	= mfn_opts_get( 'sticky-logo-img' ) ? mfn_opts_get( 'sticky-logo-img' ) : $logo_src;
							$logo_mobile 	= mfn_opts_get( 'responsive-logo-img' ) ? mfn_opts_get( 'responsive-logo-img' ) : $logo_src;
